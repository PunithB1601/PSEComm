...
<%@page import="com.customer.dto.RequestedLocation"%>
<%@page import="java.util.List"%>
<%@page import="com.customer.dao.RequestedLocationDAO"%>
<%@page import="com.customer.dao.RequestedLocationDAOImp"%>
        ...
        <table>
            ...
            <tbody>
                <%
                    ...
                    RequestedLocationDAO rdao = new RequestedLocationDAOImp();
                    List<RequestedLocation> requestedLocations = rdao.getRequested_location();

                    // Check if data exists
                    if (requestedLocations != null && !requestedLocations.isEmpty()) {
                        for (RequestedLocation location : requestedLocations) {
                %>
                <tr>
                    <td><%= location.getReq_id() %></td>
                    <td><%= location.getRequested_location() %></td>
                </tr>
                <%
                        }
                    } else {
                %>
                <tr>
                    <td colspan="2" style="text-align: center;">No requested locations found.</td>
                </tr>
                <%
                    }
                %>
