...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold text-primary" href="#">Salesman Dashboard</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link">Welcome, <%= e.getFname() %></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="d-flex">
        ...
        <div class="content flex-grow-1">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header bg-warning text-white">Performance</div>
                        <div class="card-body">
                            <p>Total Sales: $5000</p>
                            <p>Target Achieved: 75%</p>
                        </div>
                    </div>
                </div>
            </div>
